...
for k = 1:1
    ...
    end_distance(k) = mean(EED_end(2:N_monte/display_N+1));
    end_std(k) = std(EED_end(2:N_monte/display_N+1));
    dye_distance(k) = mean(EED_dye(2:N_monte/display_N+1));
    dye_std(k) = std(EED_dye(2:N_monte/display_N+1));
    
    energy_ave(k) = mean(energy_trace(2:N_monte/display_N+1));
